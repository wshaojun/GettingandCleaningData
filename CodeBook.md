This codebook describes the variables, the data and each step of the script. The print messages in the run_Analysis.R file used for debugging have been omitted here
